        ...
        CreateThread(function()
            while open do
                RageUI.IsVisible(mainMenu, function()
                    ...
                    RageUI.Button("Tabac", nil, {RightLabel = "→"}, true, {
                        onSelected = function()
                            if ESX.Game.IsSpawnPointClear({x = G_TabacJob.Pos.SpawnVehicule.x, y = G_TabacJob.Pos.SpawnVehicule.y, z = G_TabacJob.Pos.SpawnVehicule.z}, 2.0) then
                                ESX.Game.SpawnVehicle("chrono1", {x = G_TabacJob.Pos.SpawnVehicule.x, y = G_TabacJob.Pos.SpawnVehicule.y, z = G_TabacJob.Pos.SpawnVehicule.z}, G_TabacJob.Pos.SpawnVehicule.h, function(vehicle) 
